...
from qt.solver.vqa.abstract.vqa_solver import VqaSolver
from qt.solver.vqa.optimizer import Optimizer
...
class Eliminate_variables():
    ...
    def solve(self):
        ...
        for i in range(2**num_frozen_qubit):
            ...
            from qt.utils.linear_system import to_row_echelon_form

            from qt.utils.linear_system import find_basic_solution
